...
<body>
    <div class="container my-5 text-center">
        ...
        <form class="my-5" action="{{ $url }}" method="post">
            @csrf
            <div class="row">
                <div class="col-lg-6 my-3">
                    <input type="text" name="name" class="form-control" placeholder="Full Name" value="{{$customer->name}}" required>
                </div>
                <div class="col-lg-6 my-3">
                ...
                <div class="col-lg-6 my-3">
                    <select name="gender" class="form-control" required>
                        ...
                        <option value="M" {{$customer->gender == "M"? "checked" : ""}}>M</option>
                        <option value="F" {{$customer->gender == "F"? "checked" : ""}}>F</option>
                        <option value="O" {{$customer->gender == "O"? "checked" : ""}}>O</option>
                    </select>
                </div>
                <div class="col-lg-6 my-3">
